...
public:
    ...
    void setTargetFrequency(sample_t frequency);   // default 140 Hz
    void setTargetTenseness(sample_t tenseness);   // default 0.6
...
private:
    ...
    sample_t Rd, alpha, E0, epsilon, shift, Delta, Te, omega;
    sample_t totalTime;
    sample_t intensity, loudness;
    sample_t vibratoAmount, vibratoFrequency;
    bool autoWobble;
    bool isTouched;
    bool alwaysVoice;
};
