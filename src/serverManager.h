...
// Forward declare VST event structures
...
//    int getOutputBusForNode(scNode* node);
	...
	// VST Events - forwarded from server
...
private:
	// VST event handlers
	void onVSTParameterChanged(VSTParameterEvent& event);
	void onVSTParameterAutomated(VSTParameterEvent& event);
